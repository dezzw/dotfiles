...
If called interactively, toggle `Skewer-Css mode'.  If the prefix
...
If called interactively, toggle `Skewer-Html mode'.  If the
...
If called interactively, toggle `Skewer mode'.  If the prefix
argument is positive, enable the mode, and if it is zero or
negative, disable the mode.
