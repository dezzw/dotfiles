...
const todoer_1 = __importDefault(__webpack_require__(143));
const db_1 = __importDefault(__webpack_require__(177));
const guarder_1 = __importDefault(__webpack_require__(189));
const info_1 = __importDefault(__webpack_require__(196));
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const db = new db_1.default(storagePath, 'todolist', maxsize);
        const info = new info_1.default(storagePath);
        const todoer = new todoer_1.default(db, info);
        const guarder = new guarder_1.default(db, type);
        ...
        (() => __awaiter(this, void 0, void 0, function* () {
            const rtp = (yield nvim.getOption('runtimepath'));
            const paths = rtp.split(',');
            if (!paths.includes(context.extensionPath)) {
                yield nvim.command(`execute 'noa set rtp^='.fnameescape('${context.extensionPath.replace(/'/g, "''")}')`);
            }
        }))().catch(_e => { });
        ...
        subscriptions.push(coc_nvim_1.commands.registerCommand('todolist.clear', () => __awaiter(this, void 0, void 0, function* () { return yield todoer.clear(); })));
        subscriptions.push(coc_nvim_1.commands.registerCommand('todolist.closeNotice', () => __awaiter(this, void 0, void 0, function* () { return yield guarder.closeNotice(); })));
        ...
        subscriptions.push(coc_nvim_1.listManager.registerList(new todolist_1.default(nvim, db)));
    });
}
...
const helper_1 = __webpack_require__(142);
class TodoList extends coc_nvim_1.BasicList {
    constructor(nvim, db) {
        ...
        this.addAction('edit', (item) => __awaiter(this, void 0, void 0, function* () {
            ...
            const config = coc_nvim_1.workspace.getConfiguration('todolist');
            if (!config.get('easyMode')) {
                yield helper_1.createTodoEditBuffer(todo, this.db, 'update', uid);
                return;
            }
            const topic = yield coc_nvim_1.workspace.requestInput('Input new topic', todo.topic);
            if (!topic || topic.trim() === '')
                return;
            todo.topic = topic.trim();
            if (config.get('promptForReminder')) {
                const remind = yield coc_nvim_1.workspace.requestInput('Set a due date?(y/N)');
                ...
                if (remind.trim().toLowerCase() === 'y') {
                    ...
                    if (!dueDate || dueDate.trim() === '')
                        return;
                    todo.due = moment_1.default(dueDate.trim(), dateFormat).toDate().toString();
                }
            }
            yield this.db.update(uid, todo);
            coc_nvim_1.workspace.showMessage('Todo item updated');
        }));
        this.addAction('delete', (item) => __awaiter(this, void 0, void 0, function* () {
            const { uid } = item.data;
            yield this.db.delete(uid);
        }), { persist: true, reload: true });
    }
    compare(a, b) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.createTodoEditBuffer = exports.isValid = exports.drawTodo = exports.parseTodo = exports.newTodo = void 0;
const coc_nvim_1 = __webpack_require__(1);
...
exports.drawTodo = drawTodo;
function isValid(todo) {
    if (todo.topic.trim() == '') {
        coc_nvim_1.workspace.showMessage('topic can not be empty', 'error');
        return false;
    }
    if (Date.parse(todo.date).toString() == 'NaN') {
        coc_nvim_1.workspace.showMessage('error date format', 'error');
        return false;
    }
    return true;
}
exports.isValid = isValid;
function createTodoEditBuffer(todo, db, action, uid) {
    return __awaiter(this, void 0, void 0, function* () {
        const { nvim } = coc_nvim_1.workspace;
        yield nvim.command('runtime plugin/coc_todolist.vim');
        const openCommand = coc_nvim_1.workspace.getConfiguration('refactor').get('openCommand');
        nvim.pauseNotification();
        ...
        const [, err] = yield nvim.resumeNotification();
        if (err) {
            logger.error(err);
            coc_nvim_1.workspace.showMessage(`Error on open todoedit window: ${err}`, 'error');
            return;
        }
        const [bufnr, width] = yield nvim.eval('[bufnr("%"), winwidth(0)]');
        const lines = drawTodo(todo, width);
        yield nvim.call('append', [0, lines]);
        yield nvim.command('normal! Gdd');
        yield nvim.call('cursor', [4, 0]);
        yield nvim.command('normal! A');
        alreadyAdded = false;
        // @todo
        // use coc's runCommand
        // https://github.com/neoclide/coc.nvim/issues/2054
        coc_nvim_1.events.on('BufWriteCmd', () => __awaiter(this, void 0, void 0, function* () {
            if (alreadyAdded) {
                coc_nvim_1.workspace.showMessage('Todo item already added', 'warning');
                return;
            }
            if (!bufChanged) {
        ...
        coc_nvim_1.workspace.onDidChangeTextDocument(() => {
            bufChanged = true;
            alreadyAdded = false;
        });
    });
}
exports.createTodoEditBuffer = createTodoEditBuffer;
...
const coc_nvim_1 = __webpack_require__(1);
const io_1 = __webpack_require__(2);
const path_1 = __importDefault(__webpack_require__(144));
const gists_1 = __webpack_require__(145);
const moment_1 = __importDefault(__webpack_require__(6));
const helper_1 = __webpack_require__(142);
class Todoer {
    constructor(db, info) {
    ...
    create() {
        return __awaiter(this, void 0, void 0, function* () {
            const todo = helper_1.newTodo();
            const config = coc_nvim_1.workspace.getConfiguration('todolist');
            if (!config.get('easyMode')) {
                yield helper_1.createTodoEditBuffer(todo, this.db, 'create');
                return;
            }
            const topic = yield coc_nvim_1.workspace.requestInput('Input the topic');
            if (!topic || topic.trim() === '')
                return;
            todo.topic = topic.trim();
            if (config.get('promptForReminder')) {
    ...
    upload() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield this.db.load();
    ...
    clear() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.db.clear();
            coc_nvim_1.workspace.showMessage('All todos were cleared');
        });
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Gist = void 0;
const request_light_1 = __webpack_require__(146);
const url_1 = __webpack_require__(147);
const coc_nvim_1 = __webpack_require__(1);
class Gist {
    constructor() {
        this.token = '';
...
var HttpProxyAgent = __webpack_require__(150);
var HttpsProxyAgent = __webpack_require__(168);
var zlib = __webpack_require__(175);
var nls = __webpack_require__(176);
...
var Agent = __webpack_require__(153);
var inherits = __webpack_require__(4).inherits;
var debug = __webpack_require__(159)('http-proxy-agent');
...
const promisify = __webpack_require__(155);
const EventEmitter = __webpack_require__(158).EventEmitter;
...
const url = __webpack_require__(147);
...
module.exports = function () {
    ...
    var ES6Promise = __webpack_require__(156);
...
module.exports = function () {
    ...
    return __webpack_require__(157).Promise;
}();
...
try {
  var supportsColor = __webpack_require__(165);
...
const os = __webpack_require__(166);
const hasFlag = __webpack_require__(167);
...
var Agent = __webpack_require__(153);
var inherits = __webpack_require__(4).inherits;
var debug = __webpack_require__(170)('https-proxy-agent');
...
const io_1 = __webpack_require__(2);
const path_1 = __importDefault(__webpack_require__(144));
const uuid = __webpack_require__(178);
class DB {
    ...
    clear() {
        return __awaiter(this, void 0, void 0, function* () {
            yield io_1.writeFile(this.file, JSON.stringify([], null, 2));
        });
    }
}
exports.default = DB;
...
/* harmony import */ var _v1_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(179);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "v1", function() { return _v1_js__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _v3_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(183);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "v3", function() { return _v3_js__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _v4_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(186);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "v4", function() { return _v4_js__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _v5_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(187);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _rng_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(180);
/* harmony import */ var _bytesToUuid_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(182);
...
/* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(181);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _v35_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(184);
/* harmony import */ var _md5_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(185);
...
/* harmony import */ var _bytesToUuid_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(182);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _v35_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(184);
/* harmony import */ var _sha1_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(188);
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const floatWindow_1 = __importDefault(__webpack_require__(190));
const virtualText_1 = __importDefault(__webpack_require__(194));
const dispose_1 = __webpack_require__(195);
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const highligher_1 = __importDefault(__webpack_require__(191));
class FloatWindow {
    constructor(nvim) {
        this.nvim = nvim;
        this.window = null;
...
Object.defineProperty(exports, "__esModule", { value: true });
const ansiparse_1 = __webpack_require__(192);
const string_1 = __webpack_require__(193);
/**
