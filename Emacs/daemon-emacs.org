...
#+PROPERTY: header-args:emacs-lisp :tangle  ~/.dotfiles/Emacs/emacs-configs/daemon-emacs/init.el :mkdirp yes
* Some improve in early-init
#+begin_src emacs-lisp :tangle ~/.dotfiles/Emacs/emacs-configs/daemon-emacs/early-init.el
...
** COMMENT Org Latex Impatient
 ...
 #+end_src
** Org Agenda
#+begin_src emacs-lisp :tangle ~/.dotfiles/Emacs/emacs-configs/daemon-emacs/lisp/init-org-agenda.el
(with-eval-after-load 'org
...
#+begin_src emacs-lisp :tangle ~/.dotfiles/Emacs/emacs-configs/daemon-emacs/lisp/init-meow-dvorak.el
(defun meow-setup ()
...
#+begin_src emacs-lisp :tangle ~/.dotfiles/Emacs/emacs-configs/daemon-emacs/lisp/init-meow-dvp.el
(defun meow-setup ()
...
#+begin_src emacs-lisp :tangle ~/.dotfiles/Emacs/emacs-configs/daemon-emacs/lisp/init-meow-qwerty.el
(defun meow-setup ()
...
(use-package rime
  ...
  (rime-librime-root "~/.dotfiles/Emacs/emacs-configs/daemon-emacs/librime/dist")
  )
#+end_src
* Company
** Company Mode
